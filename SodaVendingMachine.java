 ...
 * @author binhn
 */
public class SodaVendingMachine implements IAllThingsVendingMachine<Soda> {
    ...
    //_____________________________________________________
    @Override
    public void TakeMoney(double userInputValue, double amount, Queue<Soda> a) {
               ...
               while(ContinueLoop == true){
                ...
                switch (userChoice) {
                  ...
                  case "Q":
                    ...
                    System.out.println("We will get you back to our soda menu");
    ...
    @Override
    public void ReturnMoney(double change, Queue<Soda> a) {
    ...
    @Override
    public Soda VendItem(Queue<Soda> slot) {
    ...
    public String GetMachineInfo() {
     ...
     String output = "S: Soda vending machine.";
    ...
    @Override
    public String DisplayContents(Queue<Soda> a, Queue<Soda> b, Queue<Soda> c) {
     
     Soda A = a.peek();
     Soda B = b.peek();
     Soda C = c.peek();
    
     String output = "Welcome to soda vending machine \r\n" ;
