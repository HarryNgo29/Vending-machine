 ...
 * @author binhn
 */
public class AllThingsVendingMachine implements IAllThingsVendingMachine<AllThings>{
    ...
    //_____________________________________________________
    @Override
    public void TakeMoney(double userInputValue, double amount, Queue<AllThings> a) {
    ...
    @Override
    public void ReturnMoney(double change, Queue<AllThings> a) {
    ...
    @Override
    public AllThings VendItem(Queue<AllThings> slot) {
        
        AllThings A = new AllThings();
    ...
    @Override
    public String DisplayContents(Queue<AllThings> a, Queue<AllThings> b, Queue<AllThings> c) {
